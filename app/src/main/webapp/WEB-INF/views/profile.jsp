							...
							<li>
								<div class="clear">
									<div class="commenterImage">
										<img src="resources/images/<%= heckler.getUsername() %>.png" />HtmlUtils.htmlEscape(heckler.getBlabName())										<img src="resources/images/<%= heckler.getUsername() %>.png" />
									</div>
					...
					if (data) {
						if ('values' in data) {
							$.each(data.values, function(key, val) {
								...
								if (key === "username") {
									$('#profileImage').attr('src', 'resources/images/' + val + '.png');StringEscapeUtils.escapeXml11(comment)									$('#profileImage').attr('src', 'resources/images/' + val + '.png');
								}
							});
						}
						if ('message' in data) {
